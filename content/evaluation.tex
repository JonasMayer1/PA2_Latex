...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{img/PP_Anforderungen2.jpg}
...
\improvement{Statt Experte 1,2,3 die Namen der Experten nennen}
...
Ein weiterer Service im Bereich der Intelligenten Technologien der \ac{btp} ist SAP Conversational \acs{ai}, mit dem Chatbots erstellt, trainiert und überwacht und sowohl in SAP als auch in Drittanbieter Lösungen eingebunden werden können. Dabei gilt es anzumerken, dass der Service nicht mehr erworben werden und nur noch von Kunden, die ihn bereits erworben haben, genutzt werden kann. \autocite[Vgl.][]{CONVERSATIONALFSD2021}
...
\improvement{Fotos richtig machen, Rechtschreibung überarbeiten}
%\begin{figure}[ht]
   % \centering
    %\includegraphics[width=1\textwidth]{img/TTFTeil3E.jpg}
